 ...
 * =============================================================================================
 *	MASALAH :
 *	1. NAV return dari 1C ke 4A sering hampir masuk ke R3
 *	2. NAV R1A ke R2 sering salah follow
 *	3. api untuk ruang 1C masih sering bermasalah
 *	4. return trip dari ruang 1 saat keluar ruang 1A sering tertukar 1C
 *	SOLUSI
 *	1. nambah mundur di navigasi 1C ke 4A
 *	2. Nambah maju di navigasi 1A ke 2, karena suka salah follow
 *	3.
 *	4. ping askew dan ping rear dipakai untuk syarat.
 *
 *
 ** =============================================================================================
 *	JUMAT, 23 JUNI 2017
 ...
 *	PERUBAHAN :
 *	1. NAVIGASI 4B_NEW
 *	2. RETURN TRIP R1C dibuat follow kanan semua untuk mengindari miring keluar R1A
 *	3. RETURN TRIP R1B dibuat follow kiri
 *	4. nambah syarat ping kiri untuk navigasi dari 3 ke 1BC
 *	5. R1A ke kucing dikasih deflect kanan di fungsi navigasi
 *
 *
 *  MASALAH :
 *  1. CURVE kiri sering melebar(sudah diatasi)
 *
 * ** =============================================================================================
 *	JUMAT, 30 JUNI 2017
 * =============================================================================================
 *	PERUBAHAN :
 *	1. mengabaikan SHARP kiri (sementara karena nilainya masih bermasalah)
 *	2. mov bwd dibuat HXSPD_MED dan langkah diperlebar dgn Z = 20 (dari yang lama Z = 15)
 *	3. deflect di navigasi R4B ke 1B dihilangkan
 *	4. gerakan mundur kucing dikurangi
 *  MASALAH :
 *  1.
 *
 *
 ...
 *
 * Missing Buzzer :'(
 * Nambah routine antisipasi uv undetect sampai ruang ke-4
 * Penambahan sampai room 1 bc sp new
 *
 */
